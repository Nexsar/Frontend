...
const SmartContractUI = () => {
    ...
    const handleUpdateRewards = async () => {
        ...
        const workerAddresses = prompt("Enter worker addresses (comma-separated):").split(",");
        ...
        <div style={{ padding: '20px' }}>
            ...
            {isConnected ? (
                <>
                    ...
                    <Button onClick={handleUpdateVotingMapping} label="Update Voting Mapping" />
                    ...
                    <Button onClick={handleGetAllWorkersRewards} label="Get All Workers' Rewards" />
                </>
            ) : (
            ...
            <textarea
                readOnly
                value={output}
                style={{ width: '100%', height: '150px', marginTop: '20px', padding: '10px', fontSize: '16px' }}
            />
        </div>
    );
};
